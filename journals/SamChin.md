...
## Friday, July 28, 2023
Today we reviewed additional bugs found on our deployed site - one of which occurred due to trailing slashes in my Find Friends page as well as the Users profile for the follow functionality to not work. In addition, Anthony was able to resolve PAs bugs to determine the importance of global vs local scope and how that may cause errors. Although it was a bit of a mad dash to the last hour to get our project in a good state, I'm proud of my team and the overcoming of roadblocks along the way!

## Thursday, July 27, 2023
Today as a group we presented our project to Paul to get feedback. Unfortunately due to a recent merge to main prior to the presentations, we did have a few bugs come up mid-way through. However, it was a relief to know that each of us have the necessary minimum for a passing grade on the individual component. I'd still like to take the time to review the Edit User Profile Page that PA has worked on, as we're still seeing a few bugs with it. I am hoping I can use Anthony's Redux implementation to solve the issue. Even though we came across a few bugs, I find it super helpful to see and hear the thought process of my teammates as they are debugging. In addition, I was able to complete the README file with the help of Ethan! I was also able to revise and add some more CSS front-end styling to our website.
