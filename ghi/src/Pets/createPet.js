...
function CreatePet({ pets }) {
    ...
    const handleSubmit = async (event) => {
        ...
        // confirmAlert({
        //     customUI: ({ onClose }) => {
        //     // Define your custom UI component
        //     return (
        //         <div>
        //         <h1>Custom Confirm Alert</h1>
        //         <p>Are you sure you want to proceed?</p>
        //         <button onClick={() => {
        //             // Logic to handle 'Yes' button click
        //             alert('Click Yes from custom UI');
        ...
        <div className="offset-3 col-6">
            <div className="shadow p-4 mt-4">
                ...
                <form onSubmit={handleSubmit} id="create-pet-form">
                    ...
                    <div className="form-floating mb-3">
                        <input onChange={handleBirthdayChange} placeholder="Pet Birthday" value={birthday} required type="text" name="birthday" id="birthday" className="form-control" />
