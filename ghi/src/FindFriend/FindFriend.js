...
function FindFriend() {
    ...
    const handleFollow = async (profileCardUserId, requestingUserId) => {
        ...
        if (response.ok) {
            dispatch(fetchUser());
            console.log('user after follow', tokenUser);
                            ...
                            <div className="d-flex text-black">
                                ...
                                <div className="flex-grow-1 ms-3">
                                    <h5 className="user-name mb-1">
                                        {profileCardUser.first_name}{' '}
                                        {profileCardUser.last_name}
                                    </h5>
                                    <div className="div-tag-test d-flex justify-content-start rounded-3 p-2 mb-2">
                                        <div>
                                            {profileCardUser &&
                                                profileCardUser.pets.map(
                                                    (petId) => {
                                                        const pet = pets.find(
                                                            (pet) =>
                                                                pet.id === petId
